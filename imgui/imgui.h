...
enum ImGuiInputTextFlags_
{
    ...
    // InputInt
    ImGuiInputTextFlags_NoStepButtons = 1 << 24, // InputFloat(), InputInt(), InputScalar() etc. Display or not the steps buttons.
    ImGuiInputTextFlags_NoLabel = 1 << 25, // InputFloat(), InputInt(), InputScalar() etc. Display or not the steps buttons.
